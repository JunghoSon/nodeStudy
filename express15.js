...
router.post('/process/photo', function(req, res){
    ...
    upload(req, res, function(err){
        ...
        for(var i=0; i<files.length; i++){
            console.dir(files[i]);
            fHtml += '<tr>';
            fHtml += '  <th scope="row">originalname</th>';
            fHtml += '  <td>' + files[i].originalname + '</td>';
            fHtml += '</tr>';
            fHtml += '<tr>';
            fHtml += '  <th scope="row">mimtype</th>';
            fHtml += '  <td>' + files[i].mimetype + '</td>';
            fHtml += '</tr>';
            fHtml += '<tr>';
            fHtml += '  <th scope="row">size</th>';
            fHtml += '  <td>' + files[i].size + '</td>';
            fHtml += '</tr>';
        }
